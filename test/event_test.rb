...
class EventTest < Test::Unit::TestCase
  ...
  it 'set_value' do
    ...
    e2 = g.create_event(:k1, :k2)
    e2.k1('v1').k2('v2').post!
    assert_equal g.queue.last, {:k1=>'v1', :k2=>'v2'}

    e3 = g.create_event(:k1, :k2)
    e3.k1('v1').post!
    assert_equal g.queue.last, {:k1=>'v1'}
  end
  ...
  it 'default_value' do
    ...
    e2 = g.create_event(:k1=>'v1')
    e2.post!
    assert_equal g.queue.last, {:k1=>'v1'}

    e3 = g.create_event(:k1=>'v1', :k2=>'v2')
    e3.post!
    assert_equal g.queue.last, {:k1=>'v1', :k2=>'v2'}

    e4 = g.create_event(:k1=>'v1', :k2=>'v2')
    e4.k2('v3').post!
